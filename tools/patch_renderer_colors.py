...
"scene.add(new THREE.HemisphereLight(0xcbdcff, 0x36465e, software ? .65 : 1.05));": "scene.add(new THREE.HemisphereLight(0xcbdcff, 0x36465e, software ? .65 : .82));",
"const light = new THREE.DirectionalLight(0xffffff, software ? .8 : 1.85);": "const light = new THREE.DirectionalLight(0xffffff, software ? .8 : 1.35);",
"const rim = new THREE.DirectionalLight(0x7ecde8, software ? .3 : .75);": "const rim = new THREE.DirectionalLight(0x7ecde8, software ? .3 : .42);",
}
