...
DEEP_TRAIN = Path("deepdoors2_2choice_closed_mcq/train")
DEEP_VAL = Path("deepdoors2_2choice_closed_mcq/val")

REF_TRAIN = Path("reflect_doors_2choice_closed_mcq_split/train")
REF_VAL = Path("reflect_doors_2choice_closed_mcq_split/val")

OUT_TRAIN = Path("deepdoors2_plus_reflect_2choice_train")
OUT_VAL = Path("deepdoors2_plus_reflect_2choice_val")
